...
def main():
    ...
    parser_download_documents = subparsers.add_parser('download_documents_2025', help='Download 2025 PTK documents from the web')
    parser_download_documents.set_defaults(func='asset_tools.download_documents_2025.main')
